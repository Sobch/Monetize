...
Monetize is a simple javscript and typescript that shows some money value graphically as single coins. Currently Monetize shows some value in PLN currency. 
